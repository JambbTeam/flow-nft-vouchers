...
func main() {
	...
	//register the metadata for the voucher type with id 1
	...
	g.TransactionFromFile("mintVouchers").
		...
		//mint a dummy collectible nft that is rewarded
	...
	//admin consume the voucher and send the NFT
